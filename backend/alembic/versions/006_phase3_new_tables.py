...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('day_of_week', sa.String(10), nullable=False),  # MON, TUE, WED, THU, FRI, SAT, SUN
        sa.Column('start_time', sa.Time(), nullable=False),  # 09:00
        sa.Column('end_time', sa.Time(), nullable=False),    # 17:00
        sa.Column('break_start', sa.Time(), nullable=True),  # 12:00 (lunch)
        sa.Column('break_end', sa.Time(), nullable=True),    # 13:00
    ...
    op.create_table(
        ...
        sa.Column('table_name', sa.String(50), nullable=False),  # patients, appointments, etc.
    ...
    op.create_table(
        ...
        sa.Column('category', sa.String(50), nullable=True),  # inflammatory, neoplastic, infectious, etc.
        sa.Column('icd_code', sa.String(20), nullable=True),  # ICD-10 code
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('name', sa.String(100), nullable=False),
        sa.Column('body_part', sa.String(100), nullable=True),  # Face, Arms, Legs, Torso, etc.
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(), nullable=False, server_default=sa.func.now()),
        sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table(
        ...
        sa.Column('doctor_id', sa.Integer(), nullable=False),
        sa.Column('test_name', sa.String(200), nullable=False),  # Biopsy, Allergy Test, etc.
        sa.Column('test_date', sa.Date(), nullable=False),
        sa.Column('result_value', sa.String(100), nullable=True),  # Positive, Negative, etc.
        sa.Column('unit', sa.String(50), nullable=True),  # mg/dL, etc.
        sa.Column('reference_range', sa.String(100), nullable=True),  # 0-100
    ...
    op.create_table(
        ...
        sa.Column('route', sa.String(50), nullable=True),  # oral, topical, injection, etc.
